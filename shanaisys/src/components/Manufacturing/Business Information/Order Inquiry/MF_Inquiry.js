...
function MF_form() {
  ...
  const data = {
    inquiry_degree: inquiryDegree,
    department_id: departmentId,
  };

  /* Functions */
  const save = () => {
    Axios.post("/manufacturing/inquiry/create", data);
  };
        ...
        <div className="form__body">
          ...
          <div className="form__row">
            <div className="form__info col_3">
              ...
              <input type="text" onChange={(e) => setItemNum(e.target.value)} />
            </div>
            <div className="form__info col_3">
          ...
          <div className="form__row">
            <div className="form__info">
              ...
              <input type="text" onChange={(e) => setSpecs(e.target.value)} />
            </div>
          </div>
          <div className="form__row footer">
            ...
            <button id="cancel" onClick={() => navigate("/manufacturing")}>
              CANCEL
            </button>
          </div>
        </div>
