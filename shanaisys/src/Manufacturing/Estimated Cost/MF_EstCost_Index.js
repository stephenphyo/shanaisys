...
function MF_EstCost_Index() {
  ...
  /* useReducer */
  const [{ loading, results, filter_results }, dispatch] = useReducer(
    reducer,
    initialState
  );
              ...
              <div className="index__filter__box">
                ...
                <select
                  onChange={(e) =>
                    setFilterObj({
                      ...filterObj,
                      customer_proved: e.target.value,
                    })
                  }
                >
                  <option value="" hidden>
          ...
          <div className="index__table">
            <div className="index__table__scroll">
              <div className="index__thead">
                ...
                <div className="index__td" style={{ width: "300px" }}>
                  Customer Name
                </div>
                <div className="index__td" style={{ width: "100px" }}>
                  Drawing ID
                </div>
                <div className="index__td" style={{ width: "150px" }}>
                  Product Name
                </div>
                <div className="index__td" style={{ width: "100px" }}>
                  Variable Cost
                ...
                <div className="index__td" style={{ width: "120px" }}>
                  In-house Manpower Cost
                </div>
                <div className="index__td" style={{ width: "100px" }}>
                  Product Cost
                </div>
                  ...
                  filter_results
                    ...
                    .map((result, index) => (
                      <div className="index__tr" key={index}>
                        ...
                        <div className="index__td" style={{ width: "100px" }}>
                          {result.total_man_hours}
                        </div>
                        <div className="index__td" style={{ width: "120px" }}>
                          {result.manpower_cost}
                        </div>
                        <div className="index__td" style={{ width: "100px" }}>
                          {result.product_cost}
                        </div>
                        ...
                        <div className="index__td" style={{ width: "100px" }}>
                          <button className="action" tooltip="View">
                            <RemoveRedEyeIcon
                              ...
                              onClick={() =>
                                navigate(
                                  `/manufacturing/estcost/view/${result.id}`
                                )
                              }
                            />
                          </button>
